import{_ as p,X as t,Y as o,$ as n,a0 as a,a1 as e,Z as c,E as l}from"./framework-7c2c1cd4.js";const i="/TaiyiBlog/assets/Composite-170dc06a.png",u={},d=c(`<h2 id="名称" tabindex="-1"><a class="header-anchor" href="#名称" aria-hidden="true">#</a> 名称</h2><p>组合模式</p><h2 id="目的" tabindex="-1"><a class="header-anchor" href="#目的" aria-hidden="true">#</a> 目的</h2><p>讲对象组合成树结构以表示部分整体层次结构。组合可以是客户同一对待单个对象和组合对象。</p><h2 id="程序示例" tabindex="-1"><a class="header-anchor" href="#程序示例" aria-hidden="true">#</a> 程序示例</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 抽象组件类
 */</span>
