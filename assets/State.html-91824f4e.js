import{_ as p,X as e,Y as c,$ as s,a0 as n,a1 as t,Z as o,E as l}from"./framework-7c2c1cd4.js";const i="/TaiyiBlog/assets/有限状态机.drawio-6999ca2c.png",u={},k=o('<h2 id="名称" tabindex="-1"><a class="header-anchor" href="#名称" aria-hidden="true">#</a> 名称</h2><p>状态模式</p><h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>允许对象在内部状态改变时改变它的行为。对象看起来好像修改了它的类。</p><h2 id="程序实例" tabindex="-1"><a class="header-anchor" href="#程序实例" aria-hidden="true">#</a> 程序实例</h2><figure><img src="'+i+`" alt="有限状态机" tabindex="0" loading="lazy"><figcaption>有限状态机</figcaption></figure><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 环境类
 */</span>
