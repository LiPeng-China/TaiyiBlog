import{_ as n,X as s,Y as a,Z as t}from"./framework-7c2c1cd4.js";const e="/TaiyiBlog/assets/Strategy-00063654.png",p={},c=t(`<h2 id="名称" tabindex="-1"><a class="header-anchor" href="#名称" aria-hidden="true">#</a> 名称</h2><p>策略模式、政策模式、方针模式</p><h2 id="目的" tabindex="-1"><a class="header-anchor" href="#目的" aria-hidden="true">#</a> 目的</h2><p>定义一个家族算法，并封装好其中每一个，使他们可以相互替换。策略模式是算法的变化独立于使用它的客户。</p><h2 id="程序用例" tabindex="-1"><a class="header-anchor" href="#程序用例" aria-hidden="true">#</a> 程序用例</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 策略接口
 */</span>
